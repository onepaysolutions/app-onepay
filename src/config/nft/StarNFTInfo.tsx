      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <p className="text-sm text-gray-400">{t("nft.info.price")}</p>
              <p className="text-lg font-medium text-purple-300">${price}</p>
            </div>
            <div>
              <p className="text-sm text-gray-400">{t("nft.info.ratio")}</p>
        ...
        <div>
          ...
          <div className="space-y-3">
            <div>
              <p className="text-sm text-gray-400">{t("nft.info.earnings")}</p>
              <p className="text-lg font-medium text-purple-300">
                {(returnRate * 100)}% {t("nft.info.return")}
              </p>
            </div>
            <div>
